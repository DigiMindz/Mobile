...
public class UneDemande extends BaseForm 
{
    private com.codename1.ui.Container F = new com.codename1.ui.Container(new com.codename1.ui.layouts.BoxLayout(com.codename1.ui.layouts.BoxLayout.Y_AXIS));
    TextField TF6 = new TextField();
    TextField TF2 = new TextField();
    Session ss;
    
    public UneDemande(Session s,com.codename1.ui.util.Resources resourceObjectInstance)
    {
        super(s);
        System.out.println("OKKKKKK" + s.user.getEmail());
        this.ss = s;
        System.out.println("OKKKKKK" + ss.user.getEmail());
        initGuiBuilderComponents(resourceObjectInstance);
        installSidemenu(s,resourceObjectInstance);
        //getToolbar().addMaterialCommandToRightBar("", FontImage.MATERIAL_PUBLIC, e -> {});
        getToolbar().setTitleComponent(
                FlowLayout.encloseCenterMiddle(
                        new Label("Passer une demande", "Title")
                        
                )
      
        );
        getContentPane().setUIID("SignInForm");
        //getToolbar().addMaterialCommandToRightBar("", FontImage.MATERIAL_ARROW_BACK, ev -> { new BonsPlansForm(resourceObjectInstance).show();});
                        ...
                        B2.addActionListener(new ActionListener() 
        {
            ...
            public void actionPerformed(ActionEvent evt) 
            {
                new GoogleMapsForm(ss,resourceObjectInstance).show();
            }
        });
        C2.add(L2).add(TF2);
        C2.add(B2);
        ...
        B10.addActionListener(new ActionListener() 
        {
            ...
            public void actionPerformed(ActionEvent evt) 
            {
                ...
                Demande D = new Demande(s.user.getId(),N0,N1,N3,N4,N5,N6,Integer.parseInt(N7),N8,Integer.parseInt(N9),N10,null,null,null,null);
