 ...
 */
public class ResEtabForm extends BaseForm{
    ArrayList<Offre> ALE = new ArrayList<>();
    Etablissement E;
    Session s;
    public ResEtabForm (Session s,Etablissement E,com.codename1.ui.util.Resources resourceObjectInstance) {
        super(s);
        this.E=E;
        initGuiBuilderComponents(resourceObjectInstance);
        installSidemenu(s,resourceObjectInstance);
        setTitle("ResEtabForm");
        setName("ResEtabForm");
