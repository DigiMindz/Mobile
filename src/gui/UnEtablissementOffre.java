...
public class UnEtablissementOffre extends BaseForm
{
    ...
    public UnEtablissementOffre(Session s,Etablissement E,Resources resourceObjectInstance)
    {
        super(s);
        this.E = E;
...
add_event.addActionListener(new ActionListener() 
        ...
        setTitle("UnEtablissementOffre");
        setName("UnEtablissementOffre");
