 ...
 */
public class ReservationsFormEtab extends BaseForm{
    ArrayList<Reservation> ALE = new ArrayList<>();
    ArrayList<Reservation> ALE2 = new ArrayList<>();
    Etablissement etab;
    Session s;
    
    public ReservationsFormEtab (Session s,Etablissement etab,com.codename1.ui.util.Resources resourceObjectInstance) {
        super(s);
        this.etab=etab;
...
//        getToolbar().addMaterialCommandToRightBar("",FontImage.MATERIAL_ARROW_BACK, e -> last.show());
        ...
        getToolbar().setTitleComponent(
                FlowLayout.encloseCenterMiddle(
                        new Label("Vos réservations", "Title")
            ...
            public void dataChanged(int type, int index) {
                    ...
                    if (motcle.equals("")){
                    ALE = ser.getListEtab(etab);
                    }
                    else {
                     ALE = ser.getMot(motcle,etab.getId());
                    }
