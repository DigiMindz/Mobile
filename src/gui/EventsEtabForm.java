 ...
 */
public class EventsEtabForm extends BaseForm{
    ArrayList<Evenement> ALE = new ArrayList<>();
    Session session;
    Etablissement E;
    public EventsEtabForm (Session s,Etablissement E,com.codename1.ui.util.Resources resourceObjectInstance) {
       super(s);
        this.E=E;
        initGuiBuilderComponents(resourceObjectInstance);
        setTitle("EventsEtabForm");
        setName("EventsEtabForm");
        installSidemenu(s,resourceObjectInstance);
//        getToolbar().addMaterialCommandToRightBar("", FontImage.MATERIAL_ARROW_BACK, e -> {UnEtablissement h=new UnEtablissement(E,resourceObjectInstance);
//             h.show();});
    ...
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
       ...
       setScrollableY(true);
        ...
        gui_Multi_Button_1_.addPointerPressedListener(new ActionListener() 
                {
                 ...
                 public void actionPerformed(ActionEvent evt) 
                   {
                      UnEtablissementEvent UE = new UnEtablissementEvent(session,E.getId_etablissement(),resourceObjectInstance);
                      UE.show();
                  }
              });
        ...
        if (interSer.check(E.getId(), s.user.getId())==0){
        ...
        if (goSer.check(E.getId(), s.user.getId())==0){
