 ...
 */
public class OffresEtabForm extends BaseForm{
    ArrayList<Offre> ALE = new ArrayList<>();
    Etablissement E;
    Session s;
    public OffresEtabForm (Session s,Etablissement E,com.codename1.ui.util.Resources resourceObjectInstance) {
        super(s);
        this.E=E;
        this.s=s;
        initGuiBuilderComponents(resourceObjectInstance);
        installSidemenu(s,resourceObjectInstance);
        setTitle("OffresEtabForm");
        setName("OffresEtabForm");
