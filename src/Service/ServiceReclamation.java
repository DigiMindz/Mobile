...
public class ServiceReclamation {
    ...
    public void ajoutReclamation(Reclamation rec) {
        ...
        String Url = "http://localhost/Bons_Plans/web/app_dev.php/BonsPlans/AddRecWebSer/" + rec.getId_user()+"/"+rec.getSujet()
    ...
    {       int nb=0;
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/Bons_Plans/web/app_dev.php/BonsPlans/recidetabwebser/" + id_etab);  
    ...
    public ArrayList<Reclamation> getList2(int id){       
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/Bons_Plans/web/app_dev.php/BonsPlans/RecWebSer/"+id);  
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
